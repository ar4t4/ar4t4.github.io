<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="asif_portfolio.index" %>
...
<html lang="en">
  ...
  <body >
    <header class="header" id="header">
      <nav class="nav container">
        <a href="login.aspx" class="nav__logo">A<span id="logo1">R</span></a>
          ...
          <ul class="nav__list grid">
            ...
            <li class="nav__item">
              <a href="#work" class="nav__link">
                <i class="uil uil-message nav__icon"></i>Photography
              </a>
            <li class="nav__item">
        ...
        <div class="home__container container grid">
          <div class="home__content grid">
            <div class="home__social">
              ...
              <a
              href="https://www.facebook.com/asif.rahaman.5245961"
              target="_blank"
              class="home__social-icon"
            >
 ...
 <asp:Image ID="Image1" runat="server" CssClass="home__blob-img" Style="width: 400px; height: 387px;border-radius:50%;" />
           ...
           <!-- <img src="/asif.jpg" alt="This is asif" class="home__blob-img" style="border-radius: 50%;"> -->
            ...
            <div class="home__data">
              <h1 class="home__title">Hi, I'm Asif Rahman</h1>
              <h3 class="home__subtitle">
                Computer Science Engineering Student
              </h3>
              <p class="home__description">
                A third-year undergraduate engineering student at
                <strong>Khulna University of Engineering & Technology </strong>, Khulna.
              </p>
              <p class="tag">And I'm <span class="typing"></span></p>
          ...
          <div>
            ...
            <div class="skills__content skills__close">
              <div class="skills__header">
                ...
                <div>
                  <h1 class="skills__title">IT Based</h1>
                </div>
              ...
              <div class="skills__list grid">
                ...
                <div class="skills__data">
                  <div class="skills__titles">
                    ...
                    <span class="skills__nuber">0%</span>
                  </div>
                  <div class="skills__bar">
        ...
        >
          ...
          <div class="qualification__sections">
            ...
            >
              ...
              <div class="qualification__data">
                <div>
                  ...
                  <span class="qualification__subtitle"
                    >Bheramara Model <br />High School</span
                  >
                      ...
                      <ul class="services__modal-services grid">
                        ...
                        <li class="services__modal-service">
                          <i
                            class="uil uil-check-circle services__moda-icon"
                          ></i>
                          <p>Came runners up in inter-school Badminton</p>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div class="qualification__data">
                <div>
                  <h3 class="qualification__title">University</h3>
                  <span class="qualification__subtitle"
                    >Khulna University of Engineering & Technology,khulna</span
                  >
                  <div class="qualification__calender">
                    <i class="uil uil-calendar-alt"></i>
                    2022 - 2026
        ...
        <div class="portfolio__container container swiper-container">
          <div class="swiper-wrapper">
            ...
            <div class="portfolio__content grid swiper-slide">
              <img src="img/employee.jpg" class="portfolio__img" />
              ...
              <div class="portfolio__data">
                ...
                <p class="portfolio__description">
                 This project is a desktop application for employee management system. It is developed using Java and SQLite. It is a user-friendly application that allows users to manage employee details, attendance, and payroll. The application is designed to be easy to use and provides a seamless experience for users.
                </p>
                <a
                  href="https://github.com/ar4t4/Employee_management-java-swing-desktop-project"
            ...
            <!-- ------------------------portfollio 2-------------------- -->
            <div class="portfolio__content grid swiper-slide">
              <img src="img/tictactoe.jpg" class="portfolio__img" />

              <div class="portfolio__data">
                <h3 class="portfolio__title">Tic-Tac-Toe mobile application</h3>
                <p class="portfolio__description">
                 This is an android application for the classic game of Tic-Tac-Toe. It is developed using Java and Android Studio. The application features a simple and intuitive user interface, allowing users to play the game against the computer or against another player. The app is designed to be lightweight and easy to use, providing a fun and engaging experience for users.
                </p>
                <a
                  href="https://github.com/ar4t4/TicTactoe-app"
                  class="button button--flex button--small portfolio__button"
                >
                  GitHub Repository
                  <i class="uil uil-external-link-alt button__icon"></i>
            ...
            <!-- ------------------------portfollio 3-------------------- -->
            <div class="portfolio__content grid swiper-slide">
              <img src="img/tic-tac-toe.jpg" class="portfolio__img" />

              <div class="portfolio__data">
                <h3 class="portfolio__title">Tic-Tac-Toe(OOP)</h3>
                <p class="portfolio__description">
                 This is a simple Tic-Tac-Toe game developed using c++. The game is designed using Object-Oriented Programming (OOP) principles, providing a clean and modular codebase. The game features a simple and intuitive user interface, allowing users to play the game against the computer or against another player.
                </p>
                <a
                  href="https://github.com/ar4t4/tictactoe"
                  class="button button--flex button--small portfolio__button"
                >
                  GitHub Repository
                  <i class="uil uil-external-link-alt button__icon"></i>
 ...
 <section id="work" class="work">
  <div class="container">
      <h1 class="section-heading"><span>MY RECENT PHOTOGRAPHY</span></h1>
      <div class="card-wrapper">
          <div class="card">
              <div class="overlay">
                  <!-- <span>Category</span> -->
                  <a href="/img/pic 1.jpg">Click to see</a>
              </div>
          ...
          <div class="card">
              <div class="overlay">
                  <!-- <span>Category</span> -->
                  <a href="./img/pic 2.jpg">Click to see</a>
              </div>
          ...
          <div class="card">
              <div class="overlay">
                  <!-- <span>Category</span> -->
                  <a href="./img/pic3.jpg">Click to see</a>
              </div>
          ...
          <div class="card">
              <div class="overlay">
                  <!-- <span>Category</span> -->
                  <a href="./img/pic 4.jpg">Click to see</a>
              </div>
          ...
          <div class="card">
              <div class="overlay">
                  <!-- <span>Category</span> -->
                  <a href="./img/pic5.jpg">Click to see</a>
              </div>
          ...
          <div class="card">
              <div class="overlay">
                  <!-- <span>Category</span> -->
                  <a href="./img/pic6.jpg">Click to see</a>
              </div>
          ...
          <div>
            <div class="contact__information">
              ...
              <div>
                ...
                <span class="contact__subtitle"
                  ><a href="tel:6362243314"></a>+8801838229196</span
                >
              </div>
            </div>
            ...
            <div class="contact__information">
              ...
              <div>
                ...
                <span class="contact__subtitle"
                  >asifrahman00010@gmail.com</span
                >
              </div>
            </div>
            ...
            <div class="contact__information">
              ...
              <div>
                ...
                <span class="contact__subtitle"
                  >Bheramara, Kushtia, Khulna</span
                >
              </div>
            </div>
          </div>

          <form  class="contact__form grid" runat="server" method="post" onsubmit="return validateForm()">
      <%--  <div class="contact__content">>--%>
         <%--   <div class="contact__inputs grid">
              ...
              <div class="contact__content">
                <label for="" class="content__label">Subject</label>
                <input type="Email" class="contact__input" id="Subject"/>
              </div>
            </div>
            ...
            <div class="contact__content">
              ...
              <textarea cols="5" rows="7"  id="body"  class="contact__input"></textarea>
            </div>

            <div>
              <a
                href="#" onclick="sendEmail(event)"
              ...
              <!-- <div class="button button--flex">
                <button class="btns" type="submit" onclick="sendEmail()">Send message<i class="uil uil-message button__icon"></i> </button>
            </div> -->
            </div>--%>
            <div class="contact__content">
            <label for="email" class="content__label">Email</label>
            <asp:TextBox ID="email" runat="server" TextMode="Email" CssClass="contact__input" Required="true" ></asp:TextBox>
        </div>
        <div class="contact__content">
            <label for="subject" class="content__label">Subject</label>
            <asp:TextBox ID="subject" runat="server" CssClass="contact__input" Required="true"></asp:TextBox>
        </div>
        <div class="contact__content">
            <label for="message" class="content__label">Message</label>
            <asp:TextBox ID="message" runat="server" TextMode="MultiLine" CssClass="contact__input" Rows="7" Required="true"></asp:TextBox>
        </div>
              <div >
        <asp:Button ID="sendButton" runat="server" Text="Send Message" CssClass="button button--flex" OnClick="sendButton_Click"  AutoPostBack="false"/>
</div>
    ...
    <footer class="footer">
      <div class="footer__bg">
        <div class="footer__container container grid">
          <div>
            <h1 class="footer__title">Asif</h1>
            <span class="footer__subtitle"
              >Computer Science Engineering Student</span
            >
          </div>
          ...
          <div class="footer__socials">
            <a
              href="https://www.instagram.com/ar_4t4/"
        ...
        <p class="footer__copy">&#169; Asif. All right reserved</p>
      </div>
    </footer>
    ...
    <script src="https://kit.fontawesome.com/ad174b8664.js" crossorigin="anonymous"></script>
